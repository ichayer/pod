...
public class TicketRepository {
    ...
    private final Map<String, List<TrainModel>> trainsByDestination;
    ...
    public TicketRepository() {
        ...
        for (int i = 0; i < destinations.length; i++) {
            ...
            final List<TrainModel> trainList = IntStream.range(1, random.nextInt(1, 5)).mapToObj(index ->
                    new TrainModel(UUID.randomUUID().toString(), destination, String.valueOf(index), random.nextInt(10))
    ...
    public List<TrainModel> getAvailability(final String destination) {
